// GENERATED by scripts/extract-glue.js — DO NOT EDIT DIRECTLY
...
(function() {
    ...
    function __wbg_adapter_27(arg0, arg1) {
        wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h00043c578f47b025(arg0, arg1);
    }
...
globalThis.log = (output) => {
  __emit(JSON.parse(output));
};

const initReady = wasm_bindgen(cc2Module)
  .then(() => {
    service = new wasm_bindgen.Service();
    __emit({ type: "__worker_ready" });
    for (const msg of pending) service.send_input(JSON.stringify(msg));
    pending.length = 0;
  })
  .catch((err) => {
    __emit({ type: "__worker_error", message: String(err) });
  });

self.onmessage = (event) => {
  const msg = event.data;
  if (service) {
    service.send_input(JSON.stringify(msg));
  } else {
    pending.push(msg);
  }
};
